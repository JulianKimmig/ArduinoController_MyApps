...
class RoastingProfile(View):
    def get(self, request, id=None):
        ...
        return render(request, "coffe_roaster_roasting_profile.html",{'form':roasting_profile_form,'profile':roasting_profile})
    ...
    def post(self,request,id=None):
        ...
        if form.is_valid():
            ...
            data = np.array([
                ...
                for d in  roasting_profile.data.split(")") if len(d)>2
                ])
            x, y = data.T
            plt.plot(x,y,"ro-")
            image_path = os.path.join(roasting_profile.image.storage.location,"roasting_profile_{}_image.png".format(roasting_profile.id))
            ...
            return render(request, "coffe_roaster_roasting_profile.html",{'form':form,'profile':roasting_profile})
